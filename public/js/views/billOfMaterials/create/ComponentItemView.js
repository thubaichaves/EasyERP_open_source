define([
    ...
    'jQuery',
    'Underscore',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/billOfMaterials/components/ComponentItems.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/billOfMaterials/components/ComponentInputContent.html',
    '../../../populate',
    'dataService',
