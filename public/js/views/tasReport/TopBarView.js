define([
    ...
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/tasReport/TopBarTemplate.html',
    'custom',
    'constants',
    'common',
    'moment'
    ...
    var TopBarView = Backbone.View.extend({
        el           : '#top-bar',
        contentType  : CONSTANTS.TASREPORT,
        ...
        render: function () {
            ...
            var filter = Custom.retriveFromCash('tasReport.filter');
