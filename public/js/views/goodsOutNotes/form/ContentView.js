define([
    ...
    'Underscore',
    'views/tformViewBase',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/goodsOutNotes/form/ContentTemplate.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/goodsOutNotes/form/ListItemTemplate.html',
    'views/goodsOutNotes/form/FormView',
    'models/goodsOutNotesModel',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/goodsOutNotes/form/FormTemplate.html',
