define([
    ...
    'Underscore',
    'Backbone',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/WriteOff/InvoiceProductItems.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/WriteOff/InvoiceProductInputContent.html',
