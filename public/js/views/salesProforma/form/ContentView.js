define([
    ...
    'Underscore',
    'views/tformViewBase',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/salesProforma/form/ContentTemplate.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/salesProforma/form/ListItemTemplate.html',
    'models/InvoiceModel',
