define([
    ...
    'Underscore',
    'jQuery',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/reports/salesReports/InfoBySalesTemplate.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/reports/inventoryReports/ProductListingTemplate.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/reports/inventoryReports/productListing/listTemplate.html',
    'views/listViewBase',
