define([
    ...
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/reports/inventoryReports/LowStockTemplate.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/reports/inventoryReports/lowStock/listTemplate.html',
    'views/listViewBase',
