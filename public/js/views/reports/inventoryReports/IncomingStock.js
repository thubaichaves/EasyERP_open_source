define([
    ...
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/reports/inventoryReports/IncomingStockTemplate.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/reports/inventoryReports/incomingStock/listTemplate.html',
    'views/listViewBase',
