define([
    ...
    'Underscore',
    'views/listViewBase',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/bonusType/list/listHeader.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/bonusType/cancelEdit.html',
