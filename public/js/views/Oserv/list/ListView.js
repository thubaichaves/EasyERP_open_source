define([
    ...
    'jQuery',
    'Underscore',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/Oserv/list/ListHeader.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/Oserv/list/cancelEdit.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/Oserv/list/ListTotal.html',
    'views/selectView/selectView',
    'views/Oserv/CreateView',
    'views/Oserv/list/ListItemView',
    'models/OservModel',
    'collections/Oserv/filterCollection',
    'collections/Oserv/editCollection',
    'common',
    'dataService',
    'constants',
    'async',
...
], function (Backbone, $, _, listTemplate, cancelEdit, listTotal, SelectView, CreateView, ListItemView, OservModel, oservCollection, EditCollection, common, dataService, CONSTANTS, async, moment, GuideNotify) {
    'use strict';

    var OservListView = Backbone.View.extend({
        el                : '#content-holder',
        ...
        contentType       : CONSTANTS.OSERV, // needs in view.prototype.changeLocationHash
        ...
        initialize: function (options) {
            ...
            this.render();
            this.contentCollection = oservCollection;
        },
        ...
        setChangedValueToModel: function () {
            ...
            if (editedElement.length) {
                ...
                editOservModel = this.editCollection.get(editedElementRowId);

                if (!this.changedModels[editedElementRowId]) {
                    if (!editOservModel.id) {
                        this.changedModels[editedElementRowId] = editOservModel.attributes;
                    } else {
        ...
        oservTypeForDD: function (content) {
            var array = ['Clear', 'Oserv', 'Personal', 'Sick', 'Education'];
            var firstChar;
        ...
        yearForDD: function (content) {
            dataService.getData('/oserv/getYears', {}, function (response, context) {
        ...
        chooseOption: function (e) {
            ...
            if (modelId) {
                editOservModel = this.editCollection.get(modelId);

                if (!this.changedModels[modelId]) {
                    if (!editOservModel.id) {
                        this.changedModels[modelId] = editOservModel.attributes;
                    } else {
            ...
            if (elementType === '#vacType') {
                ...
                if (changedAttr && !changedAttr.vacArray) {
                    changedAttr.vacArray = _.clone(editOservModel.toJSON().vacArray);
        ...
        createItem: function () {
            ...
            var model = new OservModel(startData);
        ...
        deleteItem: function (id) {
            ...
            var answer = confirm('Oserv is empty. Do you want to delete it?');
        ...
        getVacDaysCount: function (model) {
            ...
            model.countOservDays = array.length;
            return model;
        },
        ...
        cancelChanges: function () {
            ...
            async.each(edited, function (el, cb) {
                ...
                tr.replaceWith(template({oserv: model}));
                cb();
            }, function (err) {
                if (!err) {
                    self.bindingEventsToEditedCollection(self);
