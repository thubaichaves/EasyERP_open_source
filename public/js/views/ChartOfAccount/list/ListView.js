define([
    ...
    'Underscore',
    'views/listViewBase',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/ChartOfAccount/list/ListHeader.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/ChartOfAccount/list/ListTemplate.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/ChartOfAccount/list/cancelEdit.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/ChartOfAccount/list/rowTempl.html',
