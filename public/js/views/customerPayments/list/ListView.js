define([
    ...
    'Underscore',
    'views/listViewBase',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/customerPayments/list/ListHeader.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/customerPayments/list/cancelTemplate.html',
