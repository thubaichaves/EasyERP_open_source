define([
    ...
    'Underscore',
    'views/listViewBase',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/Holiday/list/ListHeader.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/Holiday/list/cancelEdit.html',
