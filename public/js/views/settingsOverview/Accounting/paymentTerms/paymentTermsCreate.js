define([
    ...
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/settingsOverview/Accounting/paymentTerms/CreatePaymentTerms.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/settingsOverview/Accounting/paymentTerms/paymentTermsEl.html',
    'models/paymentTerm',
    'populate',
    'constants',
