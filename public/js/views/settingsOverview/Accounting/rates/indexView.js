define([
    ...
    'Underscore',
    'jQuery',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/settingsOverview/Accounting/rates/RatesList.html',
    'text!'+ (function(){try{return App.currentUser.lang;}catch{};return '';})() +'templates/settingsOverview/Accounting/rates/tableTemplate.html',
