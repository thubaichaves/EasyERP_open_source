...
define([
    ...
    var TasReportCollection = Backbone.Collection.extend({

        model       : journalEntryModel,
        url         : 'journalEntries/tasReport',
        contentType : null,
        page        : null,
        numberToShow: null,
        viewType    : 'list',
        ...
        initialize: function (options) {
            ...
            this.filter = options.filter || Custom.retriveFromCash('tasReport.filter');
            ...
            Custom.cacheToApp('tasReport.filter', options.filter);
